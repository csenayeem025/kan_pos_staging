                        ...
                        <div class="col-sm-12">
                            <form id="currentAdminForm" class="form-horizontal" method="post" action="<?php echo base_url(); ?>saveUpdateAllDiscover">
                                <div class="form-group col-md-6">
                                    <label class="col-lg-4 control-label">Brand Name (<span class="red">*</span>):</label>
                                    <div class="col-lg-8">
                                ...
                                <div class="form-group" style="display: none">
                                    ...
                                    <div class="col-lg-8">
                                        <input id="category" name="category" value="brands" class="form-control validate[required]" type="text" >
                                    </div>
                                </div> 
                                ...
                                <div class="box-footer">   
                                    ...
                                    <a href="<?php base_url(); ?>brands" class="btn btn-default pull-right btn-form-cancel---" style="margin-right:10px;" type="submit">Cancel</a>
                                </div>
                                <div class="clearfix"></div>
                            </form>
                            <input type="hidden" id="brands" />
                        </div>
            ...
            $(document).ready(function () {
                if ($('#admin_category').length > 0) {
                    ...
                    function onCategoryTableUPdate() {
                        ...
                        $.ajax({
                            url: baseUrl + 'admin/getBrandTableUPdate',
                            type: 'post',
                    ...
                    $('body').on('click','.isDelete',function(){
                        ...
                        if (confirm("Do you really want to delete Record?")) {
                            $.ajax({
                                ...
                                success: function (response) {
                                    alert('Successfully updated.');
                                    window.location = baseUrl + 'admin/brands';
                                }
                            });
                        }
                    });
